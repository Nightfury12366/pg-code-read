 ...
 *  gdb调试中的一个tuple示例
 *  p *tuple
 * {t_len = 61, t_self = {ip_blkid = {bi_hi = 65535, bi_lo = 65535}, ip_posid = 0},
 * t_tableOid = 24576, t_data = 0x55af6df0e9f8}
 */
typedef struct HeapTupleData
{
	uint32		t_len;			/* length of *t_data */
	ItemPointerData t_self;		/* SelfItemPointer */   // 指向自己的TID
	Oid			t_tableOid;		/* table the tuple came from */  // 这个tuple来自哪张表的TID
