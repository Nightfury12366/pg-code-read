...
#define HEAP_XMIN_COMMITTED		0x0100	/* t_xmin committed */ /*元组xmin对应事务已提交*/
#define HEAP_XMIN_INVALID		0x0200	/* t_xmin invalid/aborted */  /*元组xmin对应事务无效/中止*/
#define HEAP_XMIN_FROZEN		(HEAP_XMIN_COMMITTED|HEAP_XMIN_INVALID)
#define HEAP_XMAX_COMMITTED		0x0400	/* t_xmax committed */  /*元组xmax对应事务已提交*/
#define HEAP_XMAX_INVALID		0x0800	/* t_xmax invalid/aborted */ /*元组xmax对应事务无效/中止*/
